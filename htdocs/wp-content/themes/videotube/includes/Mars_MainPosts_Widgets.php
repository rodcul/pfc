...
class Mars_MainPosts_Widgets_Class extends WP_Widget{
	var $title_length = 31;
	function Mars_MainPosts_Widgets_Class(){
		$widget_ops = array( 'classname' => 'mars-mainpost-widgets', 'description' => __('VT Main Posts Widget', 'wpo') );
		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'mars-mainpost-widgets' );
		
		$this->WP_Widget( 'mars-mainpost-widgets', __('VT Main Posts Widget', 'wpo'), $widget_ops, $control_ops );		
	}
	          	...
	          	<?php endif;?>
                    ...
                    <?php if( $widget_column == 3 ):?>
	                    	...
	                    	<div class="row">
			                     <div class="carousel-inner">
			                       	...
			                       	if( $wp_query->have_posts() ) : 
				                       	...
				                       	<?php endif;?>	
				                       		<div id="post-main-<?php print $this->id; ?>-<?php the_ID();?>" <?php post_class('col-sm-4 col-xs-6');?>>
												<?php 
                   	...
                   	<?php elseif( $widget_column == 2 ):?>
						...
						<div id="post-main-<?php print $this->id; ?>-<?php the_ID();?>" <?php post_class('col-sm-6 item');?>>
							<?php 
								if(has_post_thumbnail()){
